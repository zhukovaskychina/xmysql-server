...
var MySQLErrName = map[uint16]string{
	...
	ErrWrongLockOfSystemTable:                   "You can't combine write-locking of system tables with other tables or lock basic",
	...
	ErrEventStoreFailed:                         "Failed to storebytes event %s. Error code %d from storage engine.",
