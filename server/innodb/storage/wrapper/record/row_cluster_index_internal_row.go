...
func NewClusterInternalRowHeader(frmMeta tuple) basic.FieldDataHeader {
...
func NewClusterInternalRowHeaderWithContents(frmMeta tuple, content []byte) basic.FieldDataHeader {
...
type ClusterInternalRowData struct {
	...
	PrimaryKeyMeta tuple
	Content        []byte
}

func NewClusterInternalRowData(PrimaryKeyMeta tuple) basic.FieldDataValue {
...
func NewClusterInternalRow(primaryClusterInternalTuple tuple) basic.Row {
...
func NewClusterInternalRowWithContent(content []byte, tableTuple tuple) basic.Row {
