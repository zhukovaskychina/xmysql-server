...
var (
	validSQL = []struct {
		...
		input: "select /* in valueImpl list */ 1 from t where a in (b, c)",
	}, {
		...
		input: "select /* single valueImpl expre list */ 1 from t where a in (b)",
	}, {
		input: "select /* select as a valueImpl expression */ 1 from t where a = (select a from t)",
	}, {
		input: "select /* parenthesised valueImpl */ 1 from t where a = (b)",
	}, {
		...
		input: "select /* valueImpl argument with digit */ :a1 from t",
	}, {
		input: "select /* valueImpl argument with dot */ :a.b from t",
	}, {
		...
		input: "select /* bool as select valueImpl */ a, true from t",
	}, {
		...
		input: "insert /* multi-valueImpl */ into a values (1, 2)",
	}, {
		input: "insert /* multi-valueImpl list */ into a values (1, 2), (3, 4)",
	}, {
		...
		input: "insert /* valueImpl expression list */ into a values (a + 1, 2 * 3)",
	}, {
		...
		input: "insert /* bool in insert valueImpl */ into a values (1, true, false)",
	}, {
		...
		input:  "show profile cpu for plan 1",
		output: "show profile",
	}, {
		input:  "show profiles",
		...
		input: "show schemas like '%keyspace%'",
	}, {
		input: "show schemas where 1 = 0",
	}, {
		input: "show schemas from a",
	}, {
		input: "show schemas from a where 1 = 0",
	}, {
		input: "show schemas from a like '%keyspace%'",
	}, {
		input: "show full schemas",
	}, {
		input: "show full schemas from a",
	}, {
		input:  "show full schemas in a",
		output: "show full schemas from a",
	}, {
		input: "show full schemas from a like '%keyspace%'",
	}, {
		input: "show full schemas from a where 1 = 0",
	}, {
		input: "show full schemas like '%keyspace%'",
	}, {
		input: "show full schemas where 1 = 0",
	}, {
		input:  "show triggers",
		...
		input: "select match(a1, a2) against ('foo' in natural language mode with plan expansion) from t",
	}, {
...
var (
	invalidSQL = []struct {
		...
		output: "expecting valueImpl after next at position 15 near 'id'",
	}, {
...
func init() {
	// benchQuerySize is the approximate size of the plan.
	benchQuerySize := 1000000

	// Size of valueImpl is 1/10 size of plan. Then we add
