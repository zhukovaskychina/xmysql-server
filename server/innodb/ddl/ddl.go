...
const (
	...
	DDLOwnerKey = "/xmysql-server/server/innodb/ddl/fg/owner"
	ddlPrompt   = "ddl"
...
// DDL is responsible for updating schema in data storebytes and maintaining in-memory InfoSchema cache.
type DDL interface {
	...
	GetInformationSchema() schemas.InfoSchema
...
//	//if etcdCli == nil {
//	//	// The etcdCli is nil if the storebytes is localstore which is only used for testing.
