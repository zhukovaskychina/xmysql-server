...
const (
	// DDLAllSchemaVersions is the path on etcd that is used to storebytes all servers current schema versions.
	// It's exported for testing.
	DDLAllSchemaVersions = "/xmysql-server/server/innodb/ddl/all_schema_versions"
	// DDLGlobalSchemaVersion is the path on etcd that is used to storebytes the latest schema versions.
	// It's exported for testing.
	DDLGlobalSchemaVersion = "/xmysql-server/server/innodb/ddl/global_schema_version"
