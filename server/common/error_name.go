...
var MySQLErrName = map[uint16]*ErrMessage{
	...
	ErrReady:                                    Message("%s: ready for connections.Version: '%s'  socket: '%s'  port: %d", nil),
	ErrNormalShutdown:                           Message("%s: Normal shutdown", nil),
	ErrGotSignal:                                Message("%s: Got signal %d. Aborting!", nil),
	ErrShutdownComplete:                         Message("%s: Shutdown complete", nil),
	ErrForcingClose:                             Message("%s: Forcing close of thread %d  user: '%-.48s'", nil),
	...
	ErrNoUniqueLogFile:                          Message("Can't generate a unique log-filename %-.200s.(1-999)", nil),
	...
	ErrStartup:                                  Message("%s: ready for connections.Version: '%s'  socket: '%s'  port: %d  %s", nil),
