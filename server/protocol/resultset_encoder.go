...
// NewMySQLResultSetEncoder 创建 ResultSet 编码器
...
func (e *MySQLResultSetEncoder) valueToString(value interface{}) string {
	if value == nil {
		return ""
	}
...
func (e *MySQLResultSetEncoder) CreateColumnDefinition(
	name string,
	fieldType byte,
	flags uint16,
) *ColumnDefinition {
