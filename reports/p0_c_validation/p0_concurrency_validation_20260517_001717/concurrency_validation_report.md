...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | conflict_write | PASS | 5 | 0 | 8 | 0 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_1/conflict_write.log |
| 1 | range_read | FAIL | 9 | 0 | 9 | 12 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_1/range_read.log |
| 1 | long_tx | FAIL | 4 | 0 | 6 | 0 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_1/long_tx.log |
| 1 | deadlock_wait | FAIL | 5 | 0 | 9 | 15 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_1/deadlock_wait.log |
| 2 | conflict_write | PASS | 5 | 0 | 5 | 0 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_2/conflict_write.log |
| 2 | range_read | FAIL | 9 | 0 | 9 | 12 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_2/range_read.log |
| 2 | long_tx | FAIL | 4 | 0 | 6 | 0 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_2/long_tx.log |
| 2 | deadlock_wait | FAIL | 5 | 0 | 9 | 15 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_2/deadlock_wait.log |
| 3 | conflict_write | PASS | 5 | 0 | 4 | 0 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_3/conflict_write.log |
| 3 | range_read | FAIL | 9 | 0 | 9 | 12 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_3/range_read.log |
| 3 | long_tx | FAIL | 4 | 0 | 5 | 0 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_3/long_tx.log |
| 3 | deadlock_wait | FAIL | 5 | 0 | 9 | 15 | 0 | ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/round_3/deadlock_wait.log |
...
- range_read: baseline=FAIL，rounds=FAIL FAIL FAIL;一致性=yes
- long_tx: baseline=FAIL，rounds=FAIL FAIL FAIL;一致性=yes
- deadlock_wait: baseline=FAIL，rounds=FAIL FAIL FAIL;一致性=yes
...
RESULT: PASS
report: ./reports/p0_c_validation/p0_concurrency_validation_20260517_001717/concurrency_validation_report.md
