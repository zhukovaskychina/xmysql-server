...
> **文档状态（2026-04）**：历史合并记录；协议入口见 [protocol/PROTOCOL_DOCUMENTATION_INDEX.md](./protocol/PROTOCOL_DOCUMENTATION_INDEX.md)。JDBC 联调与全量测试修复计划见 [planning/JDBC_INTEGRATION_TEST_FIX_PLAN.md](./planning/JDBC_INTEGRATION_TEST_FIX_PLAN.md)。
