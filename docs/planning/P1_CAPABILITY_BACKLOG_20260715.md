...
| P1-OPT-003 | Optimizer | Statistics, NDV, histogram refresh | Some statistics structures exist; parts are simulated or incomplete | CBO uses real table/index stats with refresh and invalidation behavior |
